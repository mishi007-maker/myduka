...
from database import get_products,get_sales,get_stock,insert_products,insert_sales,insert_stock,check_available_stock,check_user_exists,create_user,sales_per_day,sales_per_product,profit_per_day,profit_per_product
...
bcrypt=Bcrypt(app)
app.secret_key="uy4t4tflwwwwwyrgrty45"
